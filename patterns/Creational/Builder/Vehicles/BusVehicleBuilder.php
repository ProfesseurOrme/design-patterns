<?php
	...
	class BusVehicleBuilder implements Builder
	{
		...
		public function setWheels($wheels): BusVehicleBuilder
		{
			$this->vehicle->wheels = $wheels;
			return $this;
		}

		public function setEngine($engine): BusVehicleBuilder
		{
		...
		public function setDoors($doors): BusVehicleBuilder
		{
